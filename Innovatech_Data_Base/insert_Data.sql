...
INSERT INTO client (Name, Last_Name, Birthdate, Number_Phone, Email, Gender, Address) VALUES
...
INSERT INTO product (Name_Product, Description, Price, Stock, Category_id) VALUES 
    ('Heladera Whirlpool', 'No Frost 300L', 1200, 15, 1),          
    ('Lavarropas LG', 'Carga Frontal 7kg', 800, 20, 1),             
    ('Microondas Samsung', '20L Digital', 300, 25, 1),              
    ('Aire Acondicionado', 'Split 3000F', 700, 10, 5),             
    ('Smart TV LG', '55 pulgadas 4K', 1400, 8, 2),                 
    ('Aspiradora Philips', 'Sin bolsa 2000W', 200, 30, 1),          
    ('Licuadora Oster', 'Vaso vidrio 1.5L', 150, 40, 6),            
    ('Tostadora ATMA', '8 niveles de tostado', 50, 50, 6),          
    ('Cafetera Nespresso', 'Sistema de cápsulas', 250, 35, 6),      
    ('Batidora KitchenAid', 'Profesional 5L', 600, 12, 6),          
    ('Plancha a Vapor', 'Rowenta 2800W', 100, 45, 6),               
    ('Secador de Pelo', 'Philips Ionico', 75, 50, 12),              
    ('Calefactor', 'Tiro balanceado 2000 kcal', 400, 20, 5),        
    ('Ventilador de Pie', '18 pulgadas 3 velocidades', 120, 60, 5),
    ('Horno Eléctrico', 'Atma 50L convección', 220, 18, 6);        



-- Insertar datos de empleados

INSERT INTO employee (Name, Last_Name, Birthdate, Number_Phone, Email, Address) VALUES 
    ('Roberto', 'Mendez', '1980-03-15', 1156789012, 'robertomendez@mail.com', 'Corrientes 234'),
    ('Elena', 'Quiroga', '1985-07-22', 1156789013, 'elenaquiroga@mail.com', 'Medrano 456'),
    ('Carlos', 'Villanueva', '1975-11-30', 1156789014, 'carlosv@mail.com', 'Rivadavia 678'),
    ('Patricia', 'Fernandez', '1990-01-09', 1156789015, 'patriciaf@mail.com', 'Belgrano 890'),
    ('Miguel', 'Torres', '1982-04-17', 1156789016, 'migueltorres@mail.com', 'Jujuy 123'),
    ('Laura', 'Garcia', '1988-05-23', 1156789017, 'lauragarcia@mail.com', 'Las Heras 345'),
    ('Hernan', 'Martinez', '1979-08-15', 1156789018, 'hernanm@mail.com', 'Pueyrredon 567'),
    ('Sofia', 'Rojas', '1993-10-02', 1156789019, 'sofiarojas@mail.com', 'Santa Fe 789'),
    ('Gonzalo', 'Perez', '1985-12-20', 1156789020, 'gonzaloperez@mail.com', 'Cabildo 910'),
    ('Andrea', 'Lopez', '1978-02-11', 1156789021, 'andrealopez@mail.com', 'Juramento 112'),
    ('Matias', 'Silva', '1991-03-29', 1156789022, 'matiassilva@mail.com', 'Libertador 1314'),
    ('Luciana', 'Gomez', '1989-06-18', 1156789023, 'lucianagomez@mail.com', 'Ugarte 1516'),
    ('Federico', 'Diaz', '1974-09-07', 1156789024, 'federicodiaz@mail.com', 'Congreso 1718'),
    ('Mariana', 'Castro', '1992-12-12', 1156789025, 'marianacastro@mail.com', 'Larrea 1920'),
    ('Jorge', 'Alvarez', '1983-07-24', 1156789026, 'jorgealvarez@mail.com', 'Acoyte 2122');

-- Insertar datos de sucursales

INSERT INTO branch (Name_Branch, Address_Branch, Number_Phone_Branch, Email_Branch) VALUES 
...
INSERT INTO purchase (Branch_id, Product_id, Employee_id, Client_id, Quantity, Purchase_Date, Payment_id) VALUES
